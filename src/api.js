...
export const api = {
  ...
  addClientNote: (id, body, token) => apiFetch(`/api/admin/clients/${id}/notes`, { method: 'POST', body: JSON.stringify(body) }, token),
  updateClientNote: (id, noteId, body, token) => apiFetch(`/api/admin/clients/${id}/notes/${noteId}`, { method: 'PUT', body: JSON.stringify(body) }, token),
