...
const styles = {
  ...
  day: { fontSize: 11, letterSpacing: '0.06em', color: '#C9A84C', textTransform: 'uppercase' },
  date: { fontSize: 28, fontWeight: 700, fontFamily: "'Playfair Display', serif", lineHeight: 1 },
  ...
  service: { fontFamily: "'Playfair Display', serif", fontSize: 16, color: '#0D0D0D', fontWeight: 600 },
  meta: { fontSize: 13, color: '#888', marginTop: 3 },
  right: { display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 },
  price: { fontSize: 16, fontWeight: 700, color: '#0D0D0D' },
